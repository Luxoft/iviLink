...
import com.luxoft.ivilink.sdk.android.lib.utils.applicationmanager.SingleEntryAppManRequestsReceiver;

public class AppmanReceiver extends SingleEntryAppManRequestsReceiver {

    @Override
    protected List<String> getSupportedServices() {
        return Arrays.asList(new String[] { "ScreenSharingServerService" });
    }
