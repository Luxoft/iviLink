...
public class Utils {
	...
	public static void showShutdownMessage(final Context _context, String message) {
		showMessage(_context, "Information", message, android.R.drawable.ic_dialog_info, new DialogInterface.OnClickListener() {
			@Override
