...
public class DataServiceClientImplementation extends DataManagerService {

	@Override
	protected void fillManagersMap() {
		managersMap = new HashMap<String, RequestManager>();
		managersMap
				.put(PermittedReceivers.TWITTER.toString(),
						new TweetRequestManager(this,
	...
	protected int onStartCommandImpl() {
		...
		CharSequence tickerText = "Notifications Client started!";
		long when = System.currentTimeMillis();
		Notification notification = new Notification(icon, tickerText, when);
		CharSequence contentTitle = "Notifications Client is running!";
