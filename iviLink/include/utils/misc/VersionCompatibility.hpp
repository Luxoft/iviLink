 ...
 * \brief contains information about iviLink versions compatibility
 *        now the new compatibility values are inserted to the map in constructor
 * \author Andrey Markosov
 */
class VersionCompatibility
{
public:
