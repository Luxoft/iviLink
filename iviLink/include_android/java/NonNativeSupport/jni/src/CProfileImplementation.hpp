...
class CProfileImplementation: public iviLink::Channel::ChannelHandler,
...
public:
      ...
      iviLink::Error allocateChannelAsServer(const std::string& tag, UInt32& channelID, const int priority);
      
      iviLink::Error allocateChannelAsClient(const std::string& tag, UInt32& channelID, const int priority);
