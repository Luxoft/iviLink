...
class CAndroidGuiControllerImpl : public IGuiController 
{
public:
	CAndroidGuiControllerImpl(JavaVM * pJM, jobject callbacks);
	virtual ~CAndroidGuiControllerImpl() {}
	...
	virtual void audioListPopulate(const std::string& songName, const bool isLocal);
	virtual void audioListClear();
