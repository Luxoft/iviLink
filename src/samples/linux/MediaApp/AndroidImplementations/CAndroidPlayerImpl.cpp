...
CAndroidPlayerImpl::CAndroidPlayerImpl(JavaVM * pJM, jobject callbacks)
:
	mpJM(pJM),
	mjCallbacks(callbacks),
	mLogger(Logger::getInstance("iviLink.samples.Media.CAndroidPlayerImpl"))
{
...
int CAndroidPlayerImpl::play(const std::string& source, const std::string& avform)
{
	LOG4CPLUS_TRACE_METHOD(mLogger, __PRETTY_FUNCTION__);
	iviLink::Android::JniThreadHelper jth(mpJM);
	JNIEnv * env = jth.getEnv();
...
void CAndroidPlayerImpl::volumeUp()
{
	LOG4CPLUS_TRACE_METHOD(mLogger, __PRETTY_FUNCTION__);
	LOG4CPLUS_WARN(mLogger, "This implementation does nothing");
}

void CAndroidPlayerImpl::volumeDown()
{
	LOG4CPLUS_TRACE_METHOD(mLogger, __PRETTY_FUNCTION__);
	LOG4CPLUS_WARN(mLogger, "This implementation does nothing");
}
...
bool CAndroidPlayerImpl::isTrackEnded()
{
	LOG4CPLUS_TRACE_METHOD(mLogger, __PRETTY_FUNCTION__);
	iviLink::Android::JniThreadHelper jth(mpJM);
	JNIEnv * env = jth.getEnv();
...
bool CAndroidPlayerImpl::isTrackInErrorState()
{
	LOG4CPLUS_TRACE_METHOD(mLogger, __PRETTY_FUNCTION__);	
