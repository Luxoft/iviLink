...
{
   LOG4CPLUS_TRACE_METHOD(msLogger, __PRETTY_FUNCTION__);
   mChannelID = allocateChannel("CNotificationsProfile", this, eRealTime);
   if(mChannelID != 0)
   {
 ...
 */
void CNotificationsProfile::onBufferReceived(const tChannelId channel, CBuffer const& buffer)
{   
    LOG4CPLUS_TRACE_METHOD(msLogger, __PRETTY_FUNCTION__);
