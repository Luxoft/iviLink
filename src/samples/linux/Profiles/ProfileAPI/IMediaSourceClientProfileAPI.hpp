...
class IMediaSourceClientProfile_API : public iviLink::CProfileApiBase
{
   ...
   public:
      ...
      {
      public:
         virtual void onRecallTrackList() = 0; 
         virtual void onTrackListReceived(std::string const& trackList) = 0; 
         virtual void onTrackListChanged() = 0; 
      };
