...
class ISeatClientProfile : public iviLink::CProfileApiBase
{
   IVILINK_PROFILE_API_UID(SeatClientProfile_API_UID)
public:
   ...
   virtual void moveRequest(EMoveEvent event) = 0; 
   virtual void tabRequest(EPersonEvent event) = 0; 
   virtual void heaterRequest(EPersonEvent event) = 0; 
