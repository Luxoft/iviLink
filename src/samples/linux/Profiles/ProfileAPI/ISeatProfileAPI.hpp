...
#ifndef ISEAT_PROFILE_API_HPP
#define ISEAT_PROFILE_API_HPP

#include "framework/components/ProfileManager/include/CProfile.hpp"

class ISeatProfile_API : public AXIS::Profile::CProfile
{
   public:
   ...
   protected:
      ...
      ISeatProfile_API(AXIS::Profile::IUid const& id, AXIS::Service::Uid const& sid) : CProfile(id, sid) {}
      virtual ~ISeatProfile_API() { }
}; 


#endif /* ISEAT_PROFILE_API_HPP */
