...
class IMediaStreamingServerProfile_API : public iviLink::CProfileApiBase
{
   ...
   class Callbacks : public iviLink::Profile::IProfileCallbackProxy
      {
      public:
         virtual void onStreamingServerAccepted() = 0;
         virtual void onStreamingServerUnaccepted() = 0;
      };
