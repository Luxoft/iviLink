...
public:
    typedef std::tr1::function<void (const CError& )> err_handler_callback_t;
...
protected:
    virtual void handleError( const CError& e ) // from IProfileCallbackProxy
    {
...
template<typename T, typename U>
class IStateProfileBase : public iviLink::CProfileApiBase
{
public:
