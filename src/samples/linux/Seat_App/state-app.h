...
#include "../Profiles/ProfileAPI/ISeatProfiles.hpp"
...
class state_app : public iviLink::CApp
{
 public:
    ...
    typedef ISeatSenderProfile*   sender_ptr;
    typedef ISeatReceiverProfile* receiver_ptr;
 ...
 private:
    ISeatSenderProfile::profile_callback_t   sender_cb;
    ISeatReceiverProfile::profile_callback_t receiver_cb;
