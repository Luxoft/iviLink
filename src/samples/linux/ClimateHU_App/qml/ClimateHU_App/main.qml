...
Rectangle {
    ...
    {
        CStateUpdater.tempDecDrRequest();
    }

    function tempIncDrTog()
    {
        CStateUpdater.tempIncDrRequest();
    }

    function tempDecPassTog()
    {
        CStateUpdater.tempDecPassRequest();
    }

    function tempIncPassTog()
    {
        CStateUpdater.tempIncPassRequest();
    }

    function syncTog()
    {
        CStateUpdater.syncRequest();
    }

    function fanLowTog()
    {
        CStateUpdater.fanLowRequest();
    }

    function fanMidTog()
    {
        CStateUpdater.fanMidRequest();
    }

    function fanHighTog()
    {
        CStateUpdater.fanHighRequest();
    }

    function fanIncTog()
    {
        CStateUpdater.fanIncRequest();
    }

    function fanDecTog()
    {
        CStateUpdater.fanDecRequest();
    }

    function rearTog()
    {
        CStateUpdater.rearRequest();
    }

    function frontTog()
    {
        CStateUpdater.frontRequest();
    }

    function acTog()
    {
        CStateUpdater.acRequest();
    }

    function recircTog()
    {
        CStateUpdater.recircRequest();
    }

    function autoTog()
    {
        CStateUpdater.autoRequest();
    }

    function offTog()
    {
        CStateUpdater.offRequest();
    }
