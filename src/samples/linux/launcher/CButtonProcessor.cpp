...
static const char* media_app = "./MediaApp";
static const char* seat_app = "./Seat_App";
static const char* climate_app = "./Climate_App";
static const char* restart = "./restart.sh";
static const char* restart_n = "./restart-n.sh";
static const char* shutdown = "./shutdown.sh";
static const char* unpair = "./unpair.sh";
