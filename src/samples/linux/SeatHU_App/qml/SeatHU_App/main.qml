...
Rectangle {
    ...
    Timer{
      ...
      onTriggered: CStateUpdater.initLocalRequest();
   }
    ...
    Connections {
        ...
        onBottom_x: {
            console.log("on_bottom_x");
            console.log(pos.toString());
            drive_bottom.x = pos;
        }
        onBottom_y: {
            console.log("on_bottom_y");
            console.log(pos.toString());
            drive_bottom.y = pos;
        }
        onBack_x: {
    ...
    {
        CStateUpdater.driverHeaterRequest();
    }

    function passHeaterTog()
    {
        CStateUpdater.passHeaterRequest();
    }

    function driverSeatTog()
    {
        CStateUpdater.driverSeatRequest();
    }

    function passSeatTog()
    {
        CStateUpdater.passSeatRequest();
    }

    function seatBackLeft()
    {
        CStateUpdater.backLeftRequest();
    }

    function seatBackRight()
    {
        CStateUpdater.backRightRequest();
    }

    function seatBottomUp()
    {
        CStateUpdater.bottomUpRequest();
    }

    function seatBottomDown()
    {
        CStateUpdater.bottomDownRequest();
    }

    function seatBottomLeft()
    {
        CStateUpdater.bottomLeftRequest();
    }

    function seatBottomRight()
    {
        CStateUpdater.bottomRightRequest();
    }
