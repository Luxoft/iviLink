...
public class SeatActivity extends Activity implements OnClickListener {
	...
	Limits weightLimit = new Limits(0, 40);
	static double coefX = 20; // TODO get them depending on screen resolution
	static double coefY = 20;

	SeatPosition position = new SeatPosition(new Limits(307, 337), new Limits(
			459, 489), new Limits(-40, 80)); // TODO to be fixed when ubuntu ver is fixed
	...
	/*
	 * transforms finger movements into state-changing requests
	 * (we can move seat's bottom horizontally and vertically)
	 */
		...
		((LinearLayout) findViewById(R.id.seatLeftOffset))
				.setLayoutParams(new LinearLayout.LayoutParams(0,
						LinearLayout.LayoutParams.FILL_PARENT, weightLimit
								.fullCheck(20 - position.getXOffset())));
		...
		((LinearLayout) findViewById(R.id.seatTopOffset))
				.setLayoutParams(new LinearLayout.LayoutParams(
						LinearLayout.LayoutParams.FILL_PARENT, 0, weightLimit
								.fullCheck(20 - position.getYOffset())));
