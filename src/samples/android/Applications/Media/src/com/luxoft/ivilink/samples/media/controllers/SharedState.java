...
public class SharedState {
	private static final String tag = "iviLink.samples.Media.SharedState";
	private VideoScale scale = VideoScale.FULLSCREEN;
	...
	public VideoScale getScale() {
		Log.v(tag, "getScale(): " + scale.toString());
		return scale;
	}
	...
	public VideoScale getScale(boolean silent) {
		if (!silent)
			return getScale();
		return scale;
	}
	...
	public void setScale(VideoScale scale) {
		Log.v(tag,
				"setScale(): " + this.scale.toString() + "->"
						+ scale.toString());
		this.scale = scale;
	}
