...
LOCAL_LDLIBS += -llog
LOCAL_CFLAGS := -DANDROID -DLATRACE -DLADEBUG -Wno-psabi -g -ggdb -O0
...
LOCAL_STATIC_LIBRARIES := iviLinkApplicationLibrary
LOCAL_SRC_FILES += src/com_luxoft_ivilink_samples_screensharingserver_BridgeC.cpp
LOCAL_SRC_FILES += src/CScreenSharingServer.cpp
LOCAL_C_INCLUDES += $(LINUX_PATHS)
LOCAL_C_INCLUDES += $(UTILS_INCL)
LOCAL_C_INCLUDES += $(FRAMEWORK_INCL)
LOCAL_LDLIBS += -llog
