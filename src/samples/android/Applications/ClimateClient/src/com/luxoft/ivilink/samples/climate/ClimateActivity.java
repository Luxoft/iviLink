...
public class ClimateActivity extends Activity implements OnClickListener {
	...
	public void onCreate(Bundle icicle) {
		...
		loading.show();
		registerReceiver(new UnlockGUI(), new IntentFilter("com.luxoft.ivilink.samples.unlock"));
	...
	private void initButtons() {
		...
		buttonsList.add(new ButtonStateSetter((Button) findViewById(R.id.off),
				R.drawable.off_true_selector, R.drawable.off_false_selector, JsonStrings.off));
		buttonsList.add(new ButtonStateSetter((Button) findViewById(R.id.auto),
				R.drawable.auto_true_selector, R.drawable.auto_false_selector, JsonStrings.auto));
		buttonsList.add(new ButtonStateSetter((Button) findViewById(R.id.ac),
				R.drawable.ac_true_selector, R.drawable.ac_false_selector, JsonStrings.ac));
		buttonsList.add(new ButtonStateSetter((Button) findViewById(R.id.dual),
				R.drawable.dual_true_selector,R.drawable.dual_false_selector, JsonStrings.dual));
		buttonsList.add(new ButtonStateSetter((Button) findViewById(R.id.recirc),
				R.drawable.rec_true_selector, R.drawable.rec_false_selector, JsonStrings.recirc));
		buttonsList
				.add(new ButtonStateSetter((Button) findViewById(R.id.front),
						R.drawable.front_true_selector, R.drawable.front_false_selector,
						JsonStrings.front));
		buttonsList.add(new ButtonStateSetter((Button) findViewById(R.id.rear),
				R.drawable.rear_true_selector, R.drawable.rear_false_selector, JsonStrings.rear));
		buttonsList.add(new ButtonStateSetter((Button) findViewById(R.id.fanDown),
				R.drawable.fan_down_true_selector, R.drawable.fan_down_false_selector,
				JsonStrings.fans[0]));
		buttonsList.add(new ButtonStateSetter((Button) findViewById(R.id.fanMiddle),
				R.drawable.fan_middle_true_selector, R.drawable.fan_middle_false_selector,
				JsonStrings.fans[1]));
		buttonsList.add(new ButtonStateSetter((Button) findViewById(R.id.fanTop),
				R.drawable.fan_top_true_selector, R.drawable.fan_top_false_selector,
				JsonStrings.fans[2]));

		buttonsList.add(new ButtonStateSetter((Button) findViewById(R.id.drvTempUp), -1, -1, null));
		buttonsList
				.add(new ButtonStateSetter((Button) findViewById(R.id.drvTempDown), -1, -1, null));
		buttonsList
				.add(new ButtonStateSetter((Button) findViewById(R.id.passTempUp), -1, -1, null));
		buttonsList.add(new ButtonStateSetter((Button) findViewById(R.id.passTempDown), -1, -1,
				null));
		buttonsList
				.add(new ButtonStateSetter((Button) findViewById(R.id.fanIncrease), -1, -1, null));
		buttonsList
				.add(new ButtonStateSetter((Button) findViewById(R.id.fanDecrease), -1, -1, null));
	...
	void initSliders() {
		tempPSet = new TemperatureGuiSet((ImageView) findViewById(R.id.tempPThumb),
				(TextView) findViewById(R.id.tempPVal),
				(RelativeLayout) findViewById(R.id.tempPBar), tempLimits, this);
		tempDSet = new TemperatureGuiSet((ImageView) findViewById(R.id.tempDThumb),
	...
	class UnlockGUI extends BroadcastReceiver {
