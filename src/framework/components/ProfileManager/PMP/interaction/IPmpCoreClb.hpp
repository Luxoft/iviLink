...
namespace iviLink
{
   namespace PMP
   {
      ...
      public:
         ...
         virtual bool onLock(iviLink::CUid id) = 0;
         virtual bool onUnlock(iviLink::CUid id) = 0;
         virtual void onLockAll() = 0;
         virtual void onUnlockAll() = 0;
         virtual bool onDisableByClient(iviLink::CUid id) = 0;
         virtual bool onEnableByClient(iviLink::CUid id) = 0;
