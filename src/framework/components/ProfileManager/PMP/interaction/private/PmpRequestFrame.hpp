...
//      const tPmpFrameType PMP_FRAME_TYPE_MESSAGE = 2;
      ...
      const tRequestType PMP_REQ_CORE_LOCK_ALL = 5;
      const tRequestType PMP_REQ_CORE_UNLOCK_ALL = 6;
      const tRequestType PMP_REQ_CORE_DIS_BY_CLIENT = 7;
      const tRequestType PMP_REQ_CORE_ENABLE_BY_CLNT = 8;
      const tRequestType PMP_REQ_CORE_ENABLE_BY_CLNT_ALL = 9;
