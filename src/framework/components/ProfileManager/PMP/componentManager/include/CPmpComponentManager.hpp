...
namespace AXIS
{
   ...
   namespace PMP
   {
      ...
      public:
         ...
         AXIS::AppMan::IPmpRequest * applicationManager();

         void initApplicationManagerHandler(AXIS::AppMan::IPmpHandler * pHandler);
      ...
      private:
         ...
         AXIS::PMP::Ipc::CIpcProtocol * mpIpcProtocol; ///< Pointer to IPC Protocol instance
         AXIS::conf::Configurator * mpConfig;
