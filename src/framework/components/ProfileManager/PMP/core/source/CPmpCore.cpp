 ...
 * Company           LUXOFT
 * @file             CPMPCore.cpp
 * @brief            Source file for CPMPCore class (PMP Core library)
 * @author           VPlachkov
 ***************************************************************************/
...
#include "utils/threads/include/CThreadPoolJob.hpp"
...
namespace AXIS
{
   ...
   namespace PMP
   {
      ...
      CError CPmpCore::removeProfileApi(AXIS::Profile::ApiUid profileApiUid)
      {
         LOG4CPLUS_TRACE_METHOD(msLogger, __PRETTY_FUNCTION__ );
      ...
      void CPmpCore::findProfilesAsync(AXIS::CUid profileApiUid,
      ...
      void CPmpCore::findProfilesAsync(AXIS::CUid id,
      ...
      void CPmpCore::findProfiles(AXIS::CUid profileApiUid,
            const std::map<std::string, std::string> & profileParameters
            , std::list<Profile::Uid> & profiles, bool enabledProfiles)
      {
         LOG4CPLUS_TRACE_METHOD(msLogger, __PRETTY_FUNCTION__ );
      ...
      void CPmpCore::findProfiles(AXIS::CUid id, const std::map<std::string, std::string> & profileArguments, const std::string &platform, std::list<LibInfo>& profiles, bool onlyAvailable)
      {
         LOG4CPLUS_TRACE_METHOD(msLogger, __PRETTY_FUNCTION__ );
         mProfileMutex.lock();
      ...
      bool CPmpCore::getManifest(AXIS::CUid uid, std::string & manifest)
      {
         LOG4CPLUS_TRACE_METHOD(msLogger, __PRETTY_FUNCTION__ );
      ...
      bool CPmpCore::lock(AXIS::CUid id)
      {
         LOG4CPLUS_TRACE_METHOD(msLogger, __PRETTY_FUNCTION__ );
         if (!mpCoreProtocol)
         {
      ...
      bool CPmpCore::unlock(AXIS::CUid id)
      {
         LOG4CPLUS_TRACE_METHOD(msLogger, __PRETTY_FUNCTION__ );
         if (!mpCoreProtocol)
         {
      ...
      bool CPmpCore::disableByClient(AXIS::CUid id)
      {
         LOG4CPLUS_TRACE_METHOD(msLogger, __PRETTY_FUNCTION__ );
         ...
         if (mpPim && mpPool)
         {
            struct Runner
            {
               struct Data : public IThreadPoolJobData
               {
                  IPmpPimToCore* pim;
                  AXIS::CUid id;
                  Data(IPmpPimToCore* pim, AXIS::CUid const& id):
                     pim(pim),
                     id(id)
                  {}
               };
      ...
      bool CPmpCore::enableByClient(AXIS::CUid id)
      {
         LOG4CPLUS_TRACE_METHOD(msLogger, __PRETTY_FUNCTION__ );
         if (!mpCoreProtocol)
         {
      ...
      bool CPmpCore::onLock(AXIS::CUid id)
      {
         LOG4CPLUS_TRACE_METHOD(msLogger, __PRETTY_FUNCTION__ );
         mProfileMutex.lock();
         std::map<Profile::Uid,CPmpCoreProfileInfo>::iterator it = mProfiles.find(id);
      ...
      bool CPmpCore::onUnlock(AXIS::CUid id)
      {
         LOG4CPLUS_TRACE_METHOD(msLogger, __PRETTY_FUNCTION__ );
         mProfileMutex.lock();
         std::map<Profile::Uid,CPmpCoreProfileInfo>::iterator it = mProfiles.find(id);
      ...
      bool CPmpCore::onDisableByClient(AXIS::CUid id)
      {
         LOG4CPLUS_TRACE_METHOD(msLogger, __PRETTY_FUNCTION__ );
         mProfileMutex.lock();
         std::map<Profile::Uid,CPmpCoreProfileInfo>::iterator it = mProfiles.find(id);
      ...
      bool CPmpCore::onEnableByClient(AXIS::CUid id)
      {
         LOG4CPLUS_TRACE_METHOD(msLogger, __PRETTY_FUNCTION__ );
         mProfileMutex.lock();
         std::map<Profile::Uid,CPmpCoreProfileInfo>::iterator it = mProfiles.find(id);
      ...
      bool CPmpCore::getPapiUid(AXIS::Profile::Uid const& profUid,
