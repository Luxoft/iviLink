...
namespace AXIS
{
   namespace PMP
   {
      ...
      public:
          ...
          */
         virtual bool disableByClient(AXIS::CUid id) = 0;
          ...
          * @return true if success and false if UID is unknown
          */
         virtual bool enableByClient(AXIS::CUid id) = 0;
          ...
          */
         virtual bool getManifest(AXIS::CUid uid, std::string & manifest) = 0;
          ...
          * @return true if success and false if UID is unknown
          */
         virtual bool getProfileLibPath(AXIS::Profile::Uid uid, std::string& path) = 0;
         ...
         virtual void findProfiles(AXIS::CUid id,
               ...
               , std::list<AXIS::CUid> & profiles, bool enabledProfiles = true) = 0;
      };
   }
}
