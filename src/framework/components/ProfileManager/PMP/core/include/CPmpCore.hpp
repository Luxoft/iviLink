 ...
 * Company           LUXOFT
 * @file             CPMPCore.hpp
 * @brief            Header file for CPMPCore class (PMP Core library)
 * @author           VPlachkov
 ***************************************************************************/
...
#include "framework/components/ProfileRepository/include/IProfileRepoClient.hpp"
...
#include "framework/components/ProfileManager/PMP/core/include/CPmpCoreProfileInfo.hpp"
...
namespace AXIS
{
   ...
   namespace PMP
   {
      ...
      class CPmpCore: public IPmpCoreClb, public IPmpCoreToIpc, public IPmpCoreToPim
      {
         /**
      ...
      public:
          ...
          * @return error code
          */
         CError removeProfileApi(AXIS::Profile::ApiUid id);
          ...
          * @return error code
          */
         CError removeProfile(AXIS::Profile::Uid profileUid);
          ...
          * @return error code
          */
         CError addProfileImplementation(AXIS::Profile::Uid profileID, const LibDescriptor& library);
          ...
          * @return error code
          */
         CError removeProfileImplementation(AXIS::Profile::Uid profileUid, const std::string &platform);
          ...
          */
         void findProfiles(AXIS::CUid id, const std::map<std::string, std::string> & profileArguments,
          ...
          */
         virtual bool disableByClient(AXIS::CUid id);
          ...
          * @return true if success and false if UID is unknown
          */
         virtual bool enableByClient(AXIS::CUid id);
          ...
          */
         virtual bool getManifest(AXIS::CUid uid, std::string & manifest);
          ...
          */
         virtual void findProfiles(AXIS::CUid id,
         ...
         virtual bool getPapiUid(AXIS::Profile::Uid const& profUid,
            AXIS::Profile::ApiUid& papiUid) const;
      ...
      private:
          ...
          */
         void findProfilesAsync(AXIS::CUid profileApiUid,
               const std::map<std::string, std::string> & profileParameters
          ...
          */
         void findProfilesAsync(AXIS::CUid id, const std::map<std::string, std::string> & profileArguments,
               const std::string &platform, std::list<LibInfo>& profiles, bool onlyAvailable = true);
          ...
          * @return true if success
          */
         virtual bool onLock(AXIS::CUid id);
          ...
          * @return true if success
          */
         virtual bool onUnlock(AXIS::CUid id);
          ...
          * @return true if success
          */
         virtual bool onDisableByClient(AXIS::CUid id);
          ...
          * @return true if success
          */
         virtual bool onEnableByClient(AXIS::CUid id);
