...
struct ProfileInfo
{
   ...
   AXIS::Profile::Uid uid;                    /// UID of Profile
   std::map<std::string, std::string> params; /// Profile Parameters
   int version;                               /// Version of Profile
   std::string name;                          /// Name of Profile
   AXIS::Profile::ApiUid apiUid;                        /// UID of Profile API that Profile implenents
   AXIS::Profile::Uid complement;                    /// UID of complement Profile
};
...
public:
    ...
    */
   virtual CPMALError disableByUid(AXIS::CUid id) = 0;
    ...
    * @retval CPMALError::ERROR_OTHER if any other error
    */
   virtual CPMALError enableByUid(AXIS::CUid uid) = 0;
    ...
    */
   virtual CPMALError getProfileInfo(AXIS::Profile::Uid uid, ProfileInfo & profInfo) = 0;
