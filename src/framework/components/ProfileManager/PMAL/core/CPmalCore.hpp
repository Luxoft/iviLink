...
#include "framework/components/ProfileManager/PMAL/ipc_protocol/IPMALIpcToCore.hpp"
...
namespace iviLink
{
   ...
   namespace PMAL
   {
      ...
      public:
          ...
          */
         virtual CPMALError findProfiles(iviLink::CUid id,
          ...
          */
         virtual CPMALError disableByUid(iviLink::CUid id);
          ...
          * @retval CPMALError::ERROR_OTHER if any other error
          */
         virtual CPMALError enableByUid(iviLink::CUid id);
