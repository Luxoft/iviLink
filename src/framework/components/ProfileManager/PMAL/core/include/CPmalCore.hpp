...
#include "framework/components/ProfileManager/PMAL/ipc_protocol/include/IPMALIpcToCore.hpp"
...
namespace AXIS
{
   ...
   namespace PMAL
   {
      ...
      public:
          ...
          */
         virtual CPMALError disableByUid(AXIS::CUid id);
          ...
          * @retval CPMALError::ERROR_OTHER if any other error
          */
         virtual CPMALError enableByUid(AXIS::CUid id);
          ...
          */
         virtual CPMALError getProfileInfo(AXIS::Profile::Uid id, ProfileInfo & profInfo);
