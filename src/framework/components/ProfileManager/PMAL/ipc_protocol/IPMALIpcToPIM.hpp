...
public:
    ...
    * @retval
    */
   virtual CError generatePIUID(iviLink::Profile::IUid& piuid) = 0;
    ...
    * @return
    */
   virtual CError releasePIUID(iviLink::Profile::IUid const& piuid) = 0;
    ...
    * @return
    */
   virtual CError profileDied(iviLink::Profile::IUid const& piuid) = 0;
    ...
    * @return
    */
   virtual CError readyToServe(iviLink::Service::SessionUid const& sesId) = 0;
