...
namespace AXIS
{
   namespace PMAL
   {
      ...
      public:
          ...
          */
         virtual CPMALError disableByUid(AXIS::CUid const& id) = 0;
          ...
          * @retval ERROR_OTHER ipc errors @todo proper error codes
          */
         virtual CPMALError enableByUid(AXIS::CUid const& id) = 0;
          ...
          */
         virtual CPMALError getManifest(AXIS::CUid const& uid, std::string& manifest) = 0;
          ...
          * @retval ERROR_OTHER ipc errors @todo proper error
          */
         virtual CPMALError getProfileLibPath(AXIS::Profile::Uid const& uid, std::string& path) = 0;
          ...
          * @retval ERROR_OTHER ipc errors @todo proper error
          */
         virtual CPMALError findProfiles(AXIS::CUid const& id,
