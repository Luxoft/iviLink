...
public:
    ...
    * @retval NO_ERROR service is available and ready to receive incoming profile
    * @retval @todo other error codes
    */
   virtual CError serviceRequestCallback(iviLink::Service::Uid const& serviceUID) = 0;
    ...
    * 
    * @retval NO_ERROR all ok on PMAL client's side
    * @retval @todo other error codes
    */
   virtual CError incomingProfile(iviLink::Service::Uid const& serviceUID, 
