...
#include "framework/components/AppMan/requestHandler/include/CRunApp.hpp"
#include "framework/components/AppMan/database/include/IDatabase.hpp"
#include "framework/components/AppMan/requestHandler/include/IReqHandlerForLaunch.hpp"
#include "framework/components/AppMan/requestHandler/include/IReqHandlerForAppCom.hpp"
#include "framework/components/AppMan/requestHandler/include/ILaunchThread.hpp"
...
namespace AXIS
{
   ...
   namespace AMP
   {
      ...
      public:
          ...
          */
         void initApp ( AppMan::Ipc::IConnection * pAppConnection,
...
//       IAppManProto
          ...
          */
         virtual CError useService(pid_t pid, Service::Uid service, bool use);
...
// IReqHandlerForAppCom
         ...
         AppMan::Ipc::IConnection * mpAppConnection; ///< pointer to IPC connection with applications
