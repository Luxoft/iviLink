 ...
 * (c) copyright     2012
 * Company           LUXOFT
 * @file             CLaunchThread.hpp
 * @brief            Header file for CLaunchThread class
 * @author           VPlachkov
 ***************************************************************************/
...
#include "framework/components/AppMan/launcher/include/ILauncher.hpp"
#include "framework/components/AppMan/launcher/include/ILauncherHandler.hpp"
...
namespace AXIS
{
   ...
   namespace AMP
   {
      ...
      public:
          ...
          */
         virtual void launchApp(AXIS::Service::SessionUid session, int dbId);
