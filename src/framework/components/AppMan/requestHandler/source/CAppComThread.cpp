 ...
 * (c) copyright     2012
 * Company           LUXOFT
 * @file             CAppComThread.cpp
 * @brief            Source file for CAppComThread class
 * @author           VPlachkov
 ***************************************************************************/
...
namespace AXIS
{
   ...
   namespace AMP
   {
      ...
      void CAppComThread::addRequest(AXIS::Service::SessionUid session)
      {
         LOG4CPLUS_TRACE_METHOD(msLogger, __PRETTY_FUNCTION__ );
         mpReqMutex->lock();
      ...
      void CAppComThread::addSessionRequest(pid_t pid, AXIS::Service::SessionUid session,
