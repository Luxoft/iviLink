 ...
 * (c) copyright     2012
 * Company           LUXOFT
 * @file             CProfileInfo.hpp
 * @brief            Header file for CProfileInfo class (part of Profile Repository Process)
 * @author           VPlachkov
 ***************************************************************************/
...
namespace AXIS
{
   namespace ProfileRepository
   {
      ...
      private:
         ...
         UID mUid;               ///< UID of Profile
         std::string mName;      ///< Name of Profile
         int mVersion;           ///< Version of Profile
         UID mApiUid;            ///< UID of implemented Profile API
