...
#include "framework/components/ProfileRepository/include/ProfileRepoInternalTypes.hpp"
#include "framework/components/ProfileRepository/include/CProfileRepoError.hpp"
