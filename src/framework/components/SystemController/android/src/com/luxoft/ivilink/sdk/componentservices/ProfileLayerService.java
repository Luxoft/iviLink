...
import com.luxoft.ivilink.sdk.CProfileRepositoryWrapper;
...
public class ProfileLayerService extends ProtoComponentService {
	...
	CProfileRepositoryWrapper profileRepository;
	...
	protected void startComponent(Intent intent) {
		profileRepository = new CProfileRepositoryWrapper();
		profileRepository.start(ForSDK.getProfRepoDirectory());
