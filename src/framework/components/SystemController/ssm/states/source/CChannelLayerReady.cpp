...
Logger CChannelLayerReady::sLogger = Logger::getInstance(LOG4CPLUS_TEXT("systemController.SystemStateMachine.states.CChannelLayerReady"));
CChannelLayerReady* CChannelLayerReady::mIstance = 0;

CSystemState* CChannelLayerReady::getInstance()
{
   if(0 == mIstance)
   {
	   mIstance = new CChannelLayerReady;
   }

   return mIstance;
}

CChannelLayerReady::CChannelLayerReady()
{}
...
void CChannelLayerReady::onChannelSupervisorHandshakeDone(CSystemStateMachine* stateMachine)
{
   ...
   CTriggerQueue::sendTrigger(CHANNEL_CONNECTION_ESTABLISHED);
}
