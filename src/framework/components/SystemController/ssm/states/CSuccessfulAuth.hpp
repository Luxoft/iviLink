...
class CSuccessfulAuth : public CSystemState
{
private:
...
public:
   ...
   virtual string stateName() {return "CSuccessfulAuth";}
...
protected:
	CSuccessfulAuth();
	virtual ~CSuccessfulAuth();

private:

   static CSuccessfulAuth* sInstance;
};

} /* namespace SystemController */
#endif /* SUCCESSFULAUTH_HPP_ */
