 ...
 * Company           LUXOFT
 * @file             CTarget.cpp
 * @brief            CTarget class implementation file
 * @author           PIlin
 ***************************************************************************/
...
Logger CTarget::logger = Logger::getInstance(LOG4CPLUS_TEXT("ConnectivityAgent.HAL.CTarget"));
...
ERROR_CODE CTarget::receiveFrame(const Frame& frame)
{
...
ERROR_CODE CTarget::copyFromFrame(const Frame& frame, Buffer& buffer)
{
