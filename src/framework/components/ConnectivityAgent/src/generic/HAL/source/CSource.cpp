 ...
 * Company           LUXOFT
 * @file             CSource.cpp
 * @brief            CSource class implementation file
 * @author           PIlin
 ***************************************************************************/
...
Logger CSource::logger = Logger::getInstance(LOG4CPLUS_TEXT("ConnectivityAgent.HAL.CSource"));

CSource::CSource(const UInt32 channel_id):
...
ERROR_CODE CSource::OnDispatch(Frame& frame_to_fill, const UInt32 quote)
{
...
std::list<Buffer*> CSource::CopyToFrame(Frame& frame,const UInt32 quote)
{
