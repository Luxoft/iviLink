...
* Company           LUXOFT
* @file             CQoS.hpp
* @brief            The CQoS class header file  
* @author           KSkidanov
***************************************************************************/
#ifndef CQOS_HPP
#define CQOS_HPP
...
public:
    ...
    * @param lower_threshold is the lower border for average time for channel
	 */
   void openChannel(UInt32 channel_id, UInt64 upper_threshold, UInt64 lower_threshold);
