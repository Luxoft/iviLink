 ...
 */
class CTarget: public IBufferProducer
{
private:
...
public:
    ...
    * @return
    */
   virtual ERROR_CODE returnBufferBack(Buffer* pBuffer);
...
private:
    ...
    * @return
    */
   ERROR_CODE copyFromFrame(const Frame& frame, Buffer& buffer);


private:

   typedef std::list<Buffer*> tBufferQueue;
