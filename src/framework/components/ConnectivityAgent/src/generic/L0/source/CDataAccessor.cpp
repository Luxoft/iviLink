 ...
 *
 ********************************************************************/
#include "../include/CDataAccessor.hpp"
/********************************************************************
 *
 * The other includes
 *
...
Logger CDataAccessor::logger = Logger::getInstance(LOG4CPLUS_TEXT("ConnectivityAgent.L0.CDataAccessor"));
...
void CDataAccessor::setData(UInt8* pData, UInt32 size)
{
