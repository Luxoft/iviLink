...
namespace iviLink
{
   namespace ConnectivityAgent
   {
      ...
      namespace L0
      {
         ...
         ///CTransmitDispatcher class
         /**
          * The CTransmitDispatcher class uses CThread functionality.
          * Implements the dispatching strategy RR with priorities of sending outgoing frames from different data sources.
          */
         ...
         public:
            ...
            /**
             * This enum is used to simply declare constant quotes for data sources depending of their priority
             * 
             */
            enum
            {
             ...
             */
            CTransmitDispatcher(iviLink::ConnectivityAgent::HAL::CCarrierAdapter* pCarrierAdaptor,CTransmittedFramesQueue* pTransmittedFrameQueue);
            ...
            /**
             * Open the outgoing channel with fixed number and priority. It creates CSource object for given channel, put it
             * to dispathcing registry, and establish connections between SourceAgent and appropriate Source
             * @param channel_id is the channel number
             * @param prio is the priority of a channel
             * @param bufferProducer is the reference to L0 source representaion i.e. SourceAgent to exchange the freed buffers
             * @return pointer to the created HAL source representation i.e. Source for L0 SourceAgent
             */
            const CSource* openChannel(const UInt32 channel_id, const TChannelPriority prio, iviLink::ConnectivityAgent::L1::IBufferProducer& bufferProducer);
             ...
             * @param pCarrierAdaptor  pCarrierAdaptor is the pointer to current carrier adapter which interacts with physical connection
             */   
