   ...
   namespace ConnectivityAgent
   {
      ...
      namespace L0
      {
         ...
         public:
             ...
             * @return
             */
            virtual ERROR_CODE registerProducer(iviLink::ConnectivityAgent::L1::IBufferProducer* pProducer);

            virtual ERROR_CODE unregisterProducer(iviLink::ConnectivityAgent::L1::IBufferProducer* pProducer);
             ...
             * @return
             */
            virtual ERROR_CODE consumeBuffer(iviLink::ConnectivityAgent::Buffer* data_buffer);
             ...
             * @return
             */
            virtual ERROR_CODE OnDispatch(iviLink::ConnectivityAgent::HAL::Frame& frame_to_fill,
               const UInt32 quote);
