...
CError NegotiatorClient::NegotiateChannel(std::string const& tag, UInt32 & channelId)
{
    LOG4CPLUS_TRACE_METHOD(msLogger, __PRETTY_FUNCTION__);
...
CError NegotiatorClient::UpdateMapWithCID(std::string const& tag, UInt32 & channelId)
{
    LOG4CPLUS_TRACE_METHOD(msLogger, __PRETTY_FUNCTION__);
