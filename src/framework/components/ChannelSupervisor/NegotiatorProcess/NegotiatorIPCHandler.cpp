...
//local messages
#include "../common/Messages/AllocateChannelRequest.hpp"
#include "../common/Messages/DeallocateChannelRequest.hpp"
#include "../common/Messages/AllocateChannelResponse.hpp"
#include "../common/Messages/DeallocateChannelResponse.hpp"
#include "../common/Messages/AllocateRequest.hpp"
#include "../common/Messages/DeallocateRequest.hpp"
#include "../common/Messages/AllocateResponse.hpp"
#include "../common/Messages/DeallocateResponse.hpp"
#include "../common/Messages/CAAllocDoneRequest.hpp"
#include "../common/Messages/CAAllocDoneResponse.hpp"
#include "../common/Messages/AllocateNotification.hpp"
#include "../common/Messages/MapCheckNotification.hpp"
#include "../common/Messages/UpdateMapNotification.hpp"
#include "../common/Messages/DeallocateNotification.hpp"
#include "../common/Messages/CAAllocationNotification.hpp"

#include "../common/Messages/CommandRejectResponse.hpp"
...
CError NegotiatorIPCHandler::UpdateMap(std::string tag, UInt32 cid)
{
   ...
   LOG4CPLUS_TRACE(msLogger, "NegotiatorIPCHandler::NegotiateChannel()==>ALLOCDONE");
