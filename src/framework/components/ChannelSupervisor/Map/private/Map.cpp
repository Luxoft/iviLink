...
{
   LOG4CPLUS_TRACE(msLogger,"Map::getChannelInfo()=> channel id: "+ convertIntegerToString(channelId));
   ...
   {
      LOG4CPLUS_TRACE(msLogger,"Map::getChannelInfo()=>channel exist");
...
{
   LOG4CPLUS_TRACE(msLogger,"Map::addChannelInfo()=> channel id: "+ convertIntegerToString(channelId));
...
{
   LOG4CPLUS_TRACE(msLogger,"Map::updateChannelInfo()=> channel id: "+ convertIntegerToString(channelId));
