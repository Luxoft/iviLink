...
AllocateNotification::AllocateNotification(	const char* tag, const unsigned int channelId  )
	: Notification(tag , NOTIFICATIONTTYPE_ALLOCATE)
{
	if (channelId != 0  )
	{
...
AllocateNotification::AllocateNotification(pugi::xml_document* doc) :  Notification(doc)
{
