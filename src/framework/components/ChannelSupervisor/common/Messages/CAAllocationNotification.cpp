...
CAAllocationNotification::CAAllocationNotification(	const char* tag, const unsigned int channelId  )
	: Notification(tag , NOTIFICATIONTTYPE_CA_ALLOCATE)
{
	if (channelId != 0  )
	{
...
CAAllocationNotification::CAAllocationNotification(pugi::xml_document* doc) :  Notification(doc)
{
