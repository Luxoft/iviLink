	...
	, m_responseType(responseType)
{
	...
	{
		if (m_messageDocMainNode.append_attribute("name").set_value(m_responseTypes[m_responseType].c_str()))
		{
...
Response::Response(pugi::xml_document* doc) : Message(doc)
{
...
pugi::xml_node Response::AppendErrorNode(	pugi::xml_node node,
											ErrorCode errorCode,
