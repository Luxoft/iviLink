...
DeallocateNotification::DeallocateNotification(	const char* tag, const unsigned int channelId  )
	: Notification(tag , NOTIFICATIONTTYPE_DEALLOCATE)
{
	if (channelId != 0  )
	{
...
DeallocateNotification::DeallocateNotification(pugi::xml_document* doc) :  Notification(doc)
{
