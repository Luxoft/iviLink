...
void ChannelSupervisorMsgProxy::OnRequest(iviLink::Ipc::MsgID id, UInt8 const* pPayload, UInt32 payloadSize, UInt8* const pResponseBuffer, UInt32& bufferSize, iviLink::Ipc::DirectionID)
{
...
iviLink::Ipc::MsgID ChannelSupervisorMsgProxy::CMsgIdGen::getNext()
{
   mId += 2;
   return mId;
}
