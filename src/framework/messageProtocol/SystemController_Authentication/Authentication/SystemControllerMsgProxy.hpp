...
protected:
    ...
    // Outgoing messages
    //
    CError requestAuthenticationOK();
    CError requestAuthenticationNOK();
    CError requestAuthenticationCanceled();
...
protected:
    ...
    CError requestAuthenticationState(AuthenticationToSystemController authenticationState);
