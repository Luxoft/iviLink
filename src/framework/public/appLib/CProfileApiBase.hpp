...
namespace iviLink
{
   ...
   class CProfileApiBase
   {
      friend class Profile::CProfileInternal;
   ...
   protected:
      CProfileApiBase()
         : mEnabled(false)
         , mError(CError::NoError("CProfileApiBase", "getError - no error"))
      { }
   ...
   private:
      ...
      mutable CError mError; ///< stores latest error
   };
}
