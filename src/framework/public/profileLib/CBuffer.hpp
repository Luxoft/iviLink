...
public:
    ...
    */
   CBuffer(UInt8* pBuffer, UInt32 size, bool endianConvert = true);
...
private:
   ...
   {
      static bool read(InsertIter result, CBuffer const& buf)
      {
...
class CSBuffer : public CBuffer
{
public:
   CSBuffer() :
      CBuffer(mBuffer, SIZE)
   {}
