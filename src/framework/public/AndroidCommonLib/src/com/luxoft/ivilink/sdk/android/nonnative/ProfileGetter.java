...
/**
 * Contains methods to obtain a profile implementation instance from the Service
 * Manager. It is advised not to use this class directly, but
 * {@link GenericProfileGetter} instead.
 * 
 */
public final class ProfileGetter {
	/**
	 * Gets a profile implementation of the specified profile API from Service
	 * Manager
	 * 
	 * @param serviceName
	 ...
	 *            Profile API UID
	 * @return reference to instance, or null if nothing could be obtained
	 */
	public static Object getProfile(String serviceName, String profileAPIName) {
		...
		Assertion.check(CApp.isServiceManagerCreated(), "Service Manager has not been created");
	...
	/**
	 * Releases a profile implementation of the specified profile API
	 * 
	 * @param serviceName
	 *            UID of an active service
	 * @param profileAPIName
