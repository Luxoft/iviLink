...
CAppImplementation::CAppImplementation(iviLink::Android::AppInfo appInfo, const  iviLink::Service::ListOfUids &services, jobject appExternal)
	: CApp(services, appInfo)
	, mjAppJava(appExternal)
	, mAppInfo(appInfo)
	, mLog(Logger::getInstance("CAppImplementation"))
{
	...
	midIncomingServiceBeforeLoading = env->GetMethodID(claz, "incomingServiceBeforeLoading", "(Ljava/lang/String;)V");
	midIncomingServiceAfterLoading = env->GetMethodID(claz, "incomingServiceAfterLoading", "(Ljava/lang/String;)V");
