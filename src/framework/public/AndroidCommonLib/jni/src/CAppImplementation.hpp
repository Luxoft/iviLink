...
class CAppImplementation : public iviLink::CApp
{
public:
	CAppImplementation(iviLink::Android::AppInfo appInfo, const iviLink::Service::ListOfUids &services, jobject appExternal);
