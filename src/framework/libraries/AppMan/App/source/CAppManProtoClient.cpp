 ...
 * (c) copyright     2012
 * Company           LUXOFT
 * @file             CAppManProtoClient.cpp
 * @brief            Source file for CAppManProtoClient
 * @author           VPlachkov
 ***************************************************************************/
...
namespace AXIS
{
   ...
   namespace AppMan
   {
      ...
      namespace Ipc
      {
         ...
         void CAppManProtoClient::OnConnection(AXIS::Ipc::DirectionID dirId)
         {
            LOG4CPLUS_TRACE(msLogger,"OnConnection()");
         }

         void CAppManProtoClient::OnConnectionLost(AXIS::Ipc::DirectionID dirId)
         {
            LOG4CPLUS_TRACE(msLogger,"OnConnectionLost()");
            mConLostSem.signal();
         }

         void CAppManProtoClient::OnRequest(AXIS::Ipc::MsgID id, UInt8 const* pPayload,
         ...
         AXIS::Ipc::MsgID CAppManProtoClient::genId()
         {
