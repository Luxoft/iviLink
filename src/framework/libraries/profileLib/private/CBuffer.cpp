...
CBuffer::CBuffer(UInt8* pBuffer, UInt32 size, bool endianConvert/* = true*/) :
   mSize(size),
   mReadPos(0),
   mWritePos(0),
   mpBuffer(pBuffer),
...
CBuffer::CBuffer(CBuffer const& ref) :
   mSize(ref.mSize),
...
CBuffer& CBuffer::operator=(CBuffer const& ref)
{
   mSize = ref.mSize;
   mReadPos = ref.mReadPos;
   mWritePos = ref.mWritePos;
...
UInt8* CBuffer::getBuffer() const
{
   return mpBuffer;
}

template <typename T>
bool CBuffer::write_internal(T val)
{
...
template <typename T>
bool CBuffer::read_internal(T & val) const
{
...
bool CBuffer::write( Int8  value) { return write_internal(value); }
bool CBuffer::write(UInt8  value) { return write_internal(value); }
bool CBuffer::write( Int16 value) { return write_internal(value); }
bool CBuffer::write(UInt16 value) { return write_internal(value); }
bool CBuffer::write( Int32 value) { return write_internal(value); }
bool CBuffer::write(UInt32 value) { return write_internal(value); }
bool CBuffer::write( Int64 value) { return write_internal(value); }
bool CBuffer::write(UInt64 value) { return write_internal(value); }

bool CBuffer::read( Int8  & value) const { return read_internal(value); }
bool CBuffer::read(UInt8  & value) const { return read_internal(value); }
bool CBuffer::read( Int16 & value) const { return read_internal(value); }
bool CBuffer::read(UInt16 & value) const { return read_internal(value); }
bool CBuffer::read( Int32 & value) const { return read_internal(value); }
bool CBuffer::read(UInt32 & value) const { return read_internal(value); }
bool CBuffer::read( Int64 & value) const { return read_internal(value); }
bool CBuffer::read(UInt64 & value) const { return read_internal(value); }

bool CBuffer::write(void const* pBuffer, UInt32 size)
{
...
bool CBuffer::read(UInt32 size, void * pBuffer) const
{
...
bool CBuffer::write(std::string const& value)
{
...
bool CBuffer::read(std::string & value) const
{
   UInt32 valSize = 0;
   if (!read(valSize))
      return false;
...
UInt32 CBuffer::getReadPosition() const
{
   return mReadPos;
}

UInt32 CBuffer::getWritePosition() const
{
   return mWritePos;
}

bool CBuffer::setReadPosition(UInt32 pos) const
{
   if (pos >= mSize)
   {
      return false;
...
bool CBuffer::setWritePosition(UInt32 pos)
{
   if (pos >= mSize)
   {
      return false;
