...
namespace iviLink
{
   namespace Service
   {
      ...
      public:
          ...
          */
         bool load(const Service::Uid & service);
          ...
          */
         CProfileApiBase * getProfile(const Service::Uid &service, const Profile::ApiUid &profileApi);
      ...
      private:
          ...
          */
          virtual CError serviceRequestCallback(iviLink::Service::Uid const& serviceUID);
