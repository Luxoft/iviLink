...
{
   Logger logger = Logger::getInstance(LOG4CPLUS_TEXT("test.ChannelSupervisor.Client"));
   ...
   CSignalSemaphoreInterproc::unlink("/channel_supervisor_test_server");
   CSignalSemaphoreInterproc::unlink("/channel_supervisor_test_client");
