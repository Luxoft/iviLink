...
#ifndef SYSTEM_CONTROLLER_FOR_CA_HPP
#define SYSTEM_CONTROLLER_FOR_CA_HPP
...
private:
    ...
    iviLink::Ipc::CIpc* mSystemCtrlIpc;
...
protected:
     ...
     */
    BaseError requestConnectionEstablished(UInt8 gender);
