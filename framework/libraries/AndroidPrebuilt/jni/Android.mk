...
FRAMEWORK_INCL      += $(shell find $(LIB_PREFIX)/DeviceManager/ -type d)
...
SOURCES             += $(wildcard $(FW_PREFIX)/components/ChannelSupervisor/NegotiatorClient/src/*.cpp)
SOURCES             += $(wildcard $(FW_PREFIX)/components/ChannelSupervisor/Messages/src/*.cpp)
