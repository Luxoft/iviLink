...
CAAllocateDoneResponse::CAAllocateDoneResponse(const char* tag, const unsigned int channelId)
...
CAAllocateDoneResponse::CAAllocateDoneResponse(pugi::xml_document* doc)
        : Response(doc)
{
