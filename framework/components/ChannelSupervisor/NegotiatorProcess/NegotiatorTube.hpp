...
class NegotiatorTube: public IChannelSupervisorTubeObserver, public CThread
{
public:
    NegotiatorTube();
    ~NegotiatorTube();
    ...
    /**
     * Allocates service channel and starts internal sender thread.
     */
    void init();
    ...
    void sendDataTube(std::string data);
protected:
    virtual void threadFunc();
private:
    static Logger mLogger;

    std::deque<std::string> mDataToSendQueue;
    CMutex mDataToSendQueueMutex;
    CSignalSemaphore mDataToSendQueueSema;
