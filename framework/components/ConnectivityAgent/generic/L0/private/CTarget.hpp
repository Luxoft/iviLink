   ...
   namespace ConnectivityAgent
   {
      ...
      namespace L0
      {
         ...
         public:
             ...
             * @return
             */
            virtual ERROR_CODE returnBufferBack(iviLink::ConnectivityAgent::Buffer* pBuffer);
             ...
             * @return
             */
            virtual ERROR_CODE receiveFrame(const iviLink::ConnectivityAgent::HAL::Frame& frame);
         ...
         private:
             ...
             * @return
             */
            ERROR_CODE copyFromFrame(const iviLink::ConnectivityAgent::HAL::Frame& frame,
