...
private:
	...
	iviLink::ConnectivityAgent::ConnectivityAgentError connectIpcIfNecessary();
	...
	std::deque<CCallbackWrapper*> mCallbacksQueue;
	CMutex mCallbacksQueueMutex;
	void pushCallbackToQueue(CCallbackWrapper* callback);
	CCallbackWrapper * popCallbackFromQueue();
