...
public class CProfileManagerWrapper {
	...
	public void start() {
		...
		(mThread = new Thread(new Runnable() {
			public void run() {
				startPM(Paths.getProfileRepository(), Paths.getServiceRepository());
				Log.e(Common.TAG + ".ProfileManager", "has died!");
			}
		})).start();
	}

	private native void startPM(String pathToProfileRepository, String pathToServiceRepository);
}
