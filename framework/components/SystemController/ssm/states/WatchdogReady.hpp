...
#ifndef WATCHDOG_READY_STATE_HPP
#define WATCHDOG_READY_STATE_HPP
...
class WatchdogReady : public CSystemState
{
private:
...
public:
   ...
   virtual string stateName() {return "WatchdogReady";}
...
protected:
   ...
   WatchdogReady();
   virtual ~WatchdogReady();

private:

   static WatchdogReady* sInstance;
};
